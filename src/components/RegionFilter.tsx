...
export default function RegionFilter({ setRegion, region }: RegionFilterProps) {
  return (
    <Select value={region} onValueChange={(value) => setRegion(value)}>
      <SelectTrigger className="w-[200px] h-12 md:h-14 text-xs md:text-lg text-dark-blue-300 py-[14px] md:py-[18px] px-6 border-none shadow-md">
        <SelectValue placeholder="Filter by Region" />
      </SelectTrigger>
      <SelectContent className="text-xm text-dark-blue-300 border-none">
